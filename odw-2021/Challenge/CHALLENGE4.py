...
for x in range(10, 12):
    ...
    if maxv_snr1 >= dth:
        ...
        y_mx1l = []
        while maxv_snr1 >= dth:
            print(color.BLUE + "We found a possible signal candidate in H1 at", str(snr1_xmax), "s with SNR", str(snr1_ymax) + color.END)
        ...
        print(color.CYANB + "There were no signal candidates at Hanford" + color.END)
        print(Style.RESET_ALL)
    ...
    if maxv_snr2 >= dth:
        ...
        y_mx2l = []
        while maxv_snr2 >= dth:
            print(color.GREEN + "We found a possible signal candidate in L1 at", str(snr2_xmax), "s with SNR", str(snr2_ymax) + color.END)
    ...
    if snrp_H1 > dth:
        ...
        print(color.CYANB + "There were no signal candidates at Hanford for template using m1=m2=", x, "solar masses" + color.END)
        print(Style.RESET_ALL)
    ...
    if (snrp_H1 > dth) or (snrp_L1 > dth) or ((snrp_H1 > dth) and (snrp_L1 > dth)):
        ...
        if len(dfn_1) > 0 and len(dfn_2) == 0:
            ...
            for i in range(0, dfn_1.index[-1] + 1):
                print(color.BLUE + "The signal candidate in H1 at", str(dfn_1["X1"][i]), "has a SNR of", str(dfn_1["Y1"][i]) + color.END)
            ...
            for j in range(0, dfn_2.index[-1] + 1):
                print(color.GREEN + "The signal candidate in L1 at", str(dfn_2["X2"][j]), "has a SNR of", str(dfn_2["Y2"][j]) + color.END)
            ...
            print(color.CYANB + "The following signal candidates in H1 were ruled out as glitches:" + color.END)
            print(Style.RESET_ALL)
            ...
            if len(dfo_gl1) < len(dfo_1):
                ...
                print(Style.RESET_ALL)
                for i in range(0, dfn_1.index[-1] + 1):
                    print(color.BLUE + "There is a signal candidate in H1 at", str(dfn_1["X1"][i]), "with SNR", str(dfn_1["Y1"][i]) + color.END)
            ...
            if len(dfo_gl2) < len(dfo_2):
                ...
                print(Style.RESET_ALL)
                for j in range(0, dfn_2.index[-1] + 1):
                    print(color.GREEN + "There is a signal candidate in L1 at", str(dfn_2["X2"][j]), "with SNR", str(dfn_2["Y2"][j]) + color.END)
        ...
        print("Glitches and remaining signals and stuff")
        # if len(dfn_1) == 0 and len(dfn_2) == 0:
    ...
    ############################################################
    ############################################################
    # if ((snrp_L1>dth and snrp_H1>dth) and (time_H1==time_L1)):
